...
<head>
    ...
    <link rel="shortcut icon" href="{{url('backend/icons/other/icons8_purchase_order.ico')}}" />
    ...
    <link rel="stylesheet" href="{{ asset('backend/icons/ionicons2/css/ionicons.min.css') }}">

    <link rel="stylesheet" href="{{ asset('backend/icons/fontawesome/css/all.min.css') }}">
